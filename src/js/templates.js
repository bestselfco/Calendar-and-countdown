var rightClickPopupTemplate = '<div id="popupProxy"></div>' +
	...
	'<div id="isMainCountdown" class="rightPopupDiv">Countdown to date:</div>' + 
	'<div id="setCountdownButtons">' +
	'<span id="popupButtonSetMain" class="popupButtonDate">Primary</span>' +
	'<span id="popupButtonSetSecondary" class="popupButtonDate">Secondary</span>' +
	'</div>' +
	'<div id="dayNote" class="rightPopupDiv">Note: <input type="text" id="dayNoteInput"><img class="resetButton" src="pics/reset.png" id="resetNoteButton"></div>' +
	'<div id="dayColor" class="rightPopupDiv">Color:' +
	'<span id="colors">' +
		'	<span class="colorButton" id="color1" style="background-color: #FFF700"></span>' +
		'	<span class="colorButton" id="color2" style="background-color: #FFA500"></span>' +
		'	<span class="colorButton" id="color3" style="background-color: #FF8373"></span>' +
		'	<span class="colorButton" id="color4" style="background-color: #60B9CE"></span>' +
		'	<span class="colorButton" id="color5" style="background-color: #58E000"></span>' +
		'	<span class="colorButton" id="color6" style="background-color: #B764D4"></span>' +
		'	<img class="resetButton" src="pics/reset.png" id="resetColorButton">' +
		'</span>' +
		'</div>' +
	'</div>';
