...
function addToolTip(id, elementid, showMoon)
{
	$(id).tooltip({ 
		effect: 'slide',
		offset:	[0, 0],
		predelay: 500,
		opacity: 1,
		layout: getToolTip(elementid, showMoon),
		tipClass: 'tooltip'
	}).dynamic({ bottom: { direction: 'down', bounce: true } }); 
}

function getToolTip(id, showMoon)
{
	...
	{
		var tooltipTemplate = $.tmpl( "popupTemplateNoMoon", toolTipTemplate ) ;
	}
