module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    filesCalendar: ['src/js/libraries/jquery.js', 'src/js/libraries/mustache.js', 'src/js/libraries/jworkflow-min-0.7.0.js', 'src/js/libraries/tipped/js/tipped/tipped.unpacked.js', 'src/js/date.extend.js', 'src/js/templates.js', 'src/js/external_common.js', 'src/js/functions.js','src/js/calendar.js','src/js/tooltips_tipped.js','src/js/debug.js', 'src/js/googletrack_toback.js', 'src/js/libraries/globalize.js', 'src/js/libraries/globalize/date.js', 'src/js/libraries/globalize/relative-time.js'],
